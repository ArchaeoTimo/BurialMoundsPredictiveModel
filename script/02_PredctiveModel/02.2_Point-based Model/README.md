...
The modelling approach combines Monte Carlo simulation of absence sampling with a point-based Random Forest classifier implemented in ArcGIS Pro.
...
The script *point-based_model.py* performs a single model run. Multiple runs are executed iteratively via PowerShell to obtain aggregated probability surfaces.
